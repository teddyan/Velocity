...
class TMarkCCLS2 extends Component{
    ...
    componentDidMount() {
        ...
        axios.get(global.config.url +  'Teacher/GetCCLAnswer'+this.props.location.search,{
            ...
            this.setState({
                ...
                ExamID: TExamID,
                isExpert: isExpert,
                Pardon: res.data.data.Pardon2[0],
            })
            ...
            <div className='TMarkSpeakingOverAll'>
                ...
                <div className='TMarkSpeakingAllQuestion'>
                    <div className={"TMarkSpeaking_Question"}>
                        <h1>Section 2:</h1>
                        {
                            this.state.Scenario_Audio_2.map((record, i) => {
                                return(
                                    <div key={i}>
                                        <div>Section2 Briefing:</div>
                                        <audio controls>
                        ...
                        {
                            this.state.Section2_Audio.map((record, i)=>{
                                return(
                                    <div key={i}>
                                        <div>{i + 1}:</div>
                                        ...
                                        <audio controls>
                                            <source src={this.state.NewGlobalUrl + this.state.Answer_2[i]} type={"audio/ogg"}/>
                                        </audio>
                                        <br/>
                                        <br/>
                                    </div>
